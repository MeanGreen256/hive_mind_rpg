...
| `enemies/{ranged_harasser,shielded_brute,fast_flanker}.png` | Hand-authored for hive_mind_rpg by the project team; deterministic source in `assets/sprites/generate_enemy_roster_art.py`. | CC0-1.0 | 24×24 original regular-enemy sheets for the Zone 1 roster. No third-party pixels or generated-image model output. |
